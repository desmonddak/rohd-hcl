...
class FloatingPointBF16Value extends FloatingPointValue {
  ...
  FloatingPointBF16Value(FillFPV fill)
      : super(fill, exponentWidth, mantissaWidth);

  /// A fillfull factory
  factory FloatingPointBF16Value.fill(FillFPV filler) =>
      FloatingPointBF16Value(filler);
  ...
  FloatingPointBF16Value negate() =>
      FloatingPointBF16Value(FloatingPointValue.splitLogicFill(
